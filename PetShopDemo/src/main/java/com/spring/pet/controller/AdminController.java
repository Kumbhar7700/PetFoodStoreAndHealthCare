...
public class AdminController {
    ...
    public String getProduct(Model model){
     ...
     public String getProductadd(Model model){
		 ...
		 * @PostMapping("/admin/product/add")
		 * 
		 * public String postProductadd(@ModelAttribute("products") Product product,
		 * 
		 ...
		 * 
		 * // String fileName =
		 * StringUtils.cleanPath(multipartFile.getOriginalFilename()); Product p=
		 * productService.addProduct(product);
		 * 
		 * String catName=p.getCategory().getName();
		 * 
		 * if(catName.equals("Dog"))
		 * 
		 * {
		 * 
		 * String uploadDir = "images/dog/";
		 * 
    ...
    /*-----------------------------------------------------------------------------------------------*/
     /*
		 * public String postProductadd(@ModelAttribute("products") Product product){
		 * 
		 * productService.addProduct(product); return "redirect:/admin/product"; }
		 */
